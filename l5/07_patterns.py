# Урок L5.7 — Паттерны и методы класса
#
...
# и @staticmethod — это всё ещё декораторы (привет из L4), но навешенные на методы.
...
def demo7():
    ...
    it = Item.from_dict(data)     # из словаря (привет из L4: dict -> объект)
